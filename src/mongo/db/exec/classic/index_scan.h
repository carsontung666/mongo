...
public:
     ...
     *
     * The scan still emits ordinary index-key members from its seek paths; PROJECTION_COVERED stays
     * in the plan and projects those itself, so there is one implementation of the projection.
     */
...
private:
    ...
    /** Winds the scan up. Shared by the fused and general paths. */
    StageState hitEnd();
